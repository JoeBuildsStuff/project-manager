[Skip to content →](https://linear.app/docs/github#skip-nav)
...
2. [GitHub](https://linear.app/docs/github#)
...
## [Overview⁠](https://linear.app/docs/github\#overview)

The GitHub integration offers two core functionalities:

| Link GitHub PRs | Sync GitHub issues |
| --- | --- |
| Automate your issue status by linking to a GitHub pull request or commit to follow their progress. | Sync Linear teams to GitHub repos of your choice, to automatically create and sync issues between Linear and GitHub. This will create a synced thread in the Linear issue so comments will sync both ways<br>This will only sync issues _going forward_. To import and sync historical GitHub Issues, refer to our [GitHub Issues Importer](https://linear.app/docs/github-to-linear). |

### [Permissions⁠](https://linear.app/docs/github\#permissions)
...
## [Configure⁠](https://linear.app/docs/github\#configure)

### [Enable the GitHub integration⁠](https://linear.app/docs/github\#enable-the-github-integration)
...
#### [GitHub Enterprise options⁠](https://linear.app/docs/github\#github-enterprise-options)
...
#### [Add multiple GitHub organizations⁠](https://linear.app/docs/github\#add-multiple-github-organizations)
...
#### [Branch format⁠](https://linear.app/docs/github\#branch-format)
...
### [Personal account connection⁠](https://linear.app/docs/github\#personal-account-connection)
...
### [Enable commit linking⁠](https://linear.app/docs/github\#enable-commit-linking)
...
### [Configure GitHub Issues Sync⁠](https://linear.app/docs/github\#configure-github-issues-sync)
...
## [Linking Linear issues to GitHub PRs⁠](https://linear.app/docs/github\#linking-linear-issues-to-github-prs)
...
### [Link through pull requests⁠](https://linear.app/docs/github\#link-through-pull-requests)

| Branch name | Pull request title | Magic words |
| --- | --- | --- |
| Include `issue ID` in the branch name<br>Use the _Copy git branch name_ action or shortcut Cmd/Ctrl Shift . when viewing or highlighting/selecting an issue and paste it into the new branch name in GitHub. | Include the Linear `issue ID` (e.g. ID-123) in the title when creating pull requests. | **Method**<br>Use a `magic word + issue ID` in the PR description or title (e.g. `Fixes ENG-123` or `Fixes https://linear.app/workspace/issue/ENG-123/title`). If the issue is unassigned when linking takes place, you will be added as the assignee of the issue.<br>**Magic words**<br>Linear offers _closing_ and _non-closing_ magic words for you to customize your workflow. When using a _closing_ magic word, Linear will move the issue to _In Progress_ when the branch is pushed and _Done_ when the commit is merged to the default branch. When using a _non-closing_ magic word, the linked PR or commit will still move the issue through other statuses per Workflow settings, but will not automate the issue’s status when the PR or commit merges. Instead, it will only transition the issue through to what’s configured prior to the _On PR or commit merge_ event.<br>The **closing magic words** are: `close, closes, closed, closing fix, fixes, fixed, fixing, resolve, resolves, resolved, resolving, complete, completes, completed, completing, implements, implemented, implementing` _._<br>The **non-closing magic words** are: `ref, refs, references, part of, related to, contributes to, toward, towards` _._ |

## [Link multiple issues⁠](https://linear.app/docs/github\#link-multiple-issues)
...
### [Link using commits⁠](https://linear.app/docs/github\#link-using-commits)
...
## [Viewing a linked Linear issue⁠](https://linear.app/docs/github\#viewing-a-linked-linear-issue)

### [Remove a PR from an issue⁠](https://linear.app/docs/github\#remove-a-pr-from-an-issue)
...
### [PR review state⁠](https://linear.app/docs/github\#pr-review-state)
...
### [Pull request preview links⁠](https://linear.app/docs/github\#pull-request-preview-links)
...
Vercel Preview commentsNetlify Preview comments
...
## [Workflow automation⁠](https://linear.app/docs/github\#workflow-automation)

### [Issue status updates⁠](https://linear.app/docs/github\#issue-status-updates)
...
### [Custom merge queues⁠](https://linear.app/docs/github\#custom-merge-queues)
...
### [Branch protection rules⁠](https://linear.app/docs/github\#branch-protection-rules)
...
### [Branch-specific rules⁠](https://linear.app/docs/github\#branch-specific-rules)
...
### [Auto-assign and move issue to start⁠](https://linear.app/docs/github\#auto-assign-and-move-issue-to-start)
...
## [Other settings⁠](https://linear.app/docs/github\#other-settings)

### [Linkbacks⁠](https://linear.app/docs/github\#linkbacks)
...
### [Enable Autolink⁠](https://linear.app/docs/github\#enable-autolink)
...
## [FAQ⁠](https://linear.app/docs/github\#faq)
